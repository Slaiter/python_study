...
# Напиши прогамму на на python в соответствие с заданием

a1 = input("Введите первый этап развития: ")
a2 = input("Введите второй этап развития: ")
a3 = input("Введите третий этап развития: ")

last_stage = "Homo sapiens sapiens"

print(a1, a2, a3, last_stage, sep=' => ')